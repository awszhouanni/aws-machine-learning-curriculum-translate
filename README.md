...
Now, you can access the repostories through Amazon SageMaker's notebook instances. Choose the notebook instance titled **Module #1**. Choose **Open JupyterLab.** Then, choose the folder "Module 1." Choose the JupyterNotebook titled "Translate text into spoken translations with Amazon Translate and Amazon Polly" to begin the curriculum.
